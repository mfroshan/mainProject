...
export default function AddTeam(details) {
  ...
  const formik = useFormik({
    initialValues: {
      fname: update ? details.data.team_fname : '',
      lname: update ? details.data.team_lname : '',
      Mobnum: update ? details.data.team_number : '',
      username: update ? details.data.team_username : '',

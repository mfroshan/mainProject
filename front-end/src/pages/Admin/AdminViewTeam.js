  ...
  const requestdata = 
    {
      ...
      const display = () =>{
        axios.post("http://localhost:3001/teamDisplayadmin",{
        }).then((res) => {
       if(res.data){
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers && filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                   const {team_id	 , match_id , team_username, team_fname,team_lname,team_img,team_number,Password,status } = row;
                   ...
                   if(status === 1){
                    ...
                    return (
                      <TableRow>                      
                        ...
                        <TableCell align="left">{team_username}</TableCell>
                          <TableCell align="left">{team_number}</TableCell>
                          <TableCell align="left" style={{    
                            height: "250px",width: "250px"
                          }}>
                            
                            <img  key={team_id} src= {team_img} alt="PlayerImages"/>
                        ...
                        {/* <StatusMenu ref={ref}  status={status} aid={team_id} row={row} /> */}
                        </TableCell>
                      </TableRow>
                    );
                  })}
